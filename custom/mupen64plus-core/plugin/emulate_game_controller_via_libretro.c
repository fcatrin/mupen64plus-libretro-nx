...
static void inputGetKeys_default_descriptor(void)
{
   ...
   else if (auto_map == AUTO_MAP_8BITDO)
   {
   ...
   else if (auto_map == AUTO_MAP_SWITCH_N64)
   {
	#define custom_switch_n64_map(PAD) \
	...
	{ PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_L,      "L Shoulder" },\
	{ PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R,      "R Shoulder" },\
	{ PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_L2,     "B Button" },\
	{ PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R2,     "A Button" },\
	{ PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_SELECT, "Z Trigger" },\
	{ PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_START,  "Start" },\
	{ PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_RIGHT,  "D-Pad Right" },\
	{ PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_LEFT,   "D-Pad Left" },\
	...
	static struct retro_input_descriptor desc[] = {
		custom_switch_n64_map(0)
		custom_switch_n64_map(1)
		custom_switch_n64_map(2)
		custom_switch_n64_map(3)
	   { 0 },
	};
	environ_cb(RETRO_ENVIRONMENT_SET_INPUT_DESCRIPTORS, desc);
   }
...
void inputGetKeys_default( int Control, BUTTONS *Keys )
{
   ...
   if (alternate_mapping)
   {
	  ...
	  Keys->A_BUTTON  = !!((ret & (1 << RETRO_DEVICE_ID_JOYPAD_R2)));
	  Keys->B_BUTTON  = !!((ret & (1 << RETRO_DEVICE_ID_JOYPAD_L2)));
	  Keys->R_CBUTTON = !!((ret & (1 << RETRO_DEVICE_ID_JOYPAD_A)));
